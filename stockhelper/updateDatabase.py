...
class updateDatabase():
    ...
    def check_collection(self, Companycode: str) -> bool:
    ...
    def InsertAll(self, Companycode: str) -> None:
    ...
    def updateANew(self, Companycode: str) -> None:
        # pdb.set_trace()
        tz = pytz.timezone('Asia/Shanghai')

        # latest_record_time = self.database[Companycode].aggregate(arg)
        latest_record = self.database[Companycode].\
            find({}).sort([('day', -1)]).limit(1)
    ...
    def updateAllDatabase(self) -> None:
        # pdb.set_trace()
        # count = 0
    ...
    def updateADatabase(self, Companycode: str) -> None:
        # pdb.set_trace()
